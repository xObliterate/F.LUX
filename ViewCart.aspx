                ...
                <asp:GridView ID="gv_cart" CssClass="highlight" runat="server" AutoGenerateColumns="False" DataKeyNames="ItemID" OnRowCommand="gv_cart_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Quantity">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_minus" runat="server" CommandArgument='<%# Eval("Quantity") %>' CommandName="Minus"><i class="fas fa-minus"></i></asp:LinkButton>
                                <asp:TextBox ID="tb_quantity" CssClass="center" Width="10%" runat="server" Text='<%# Eval("Quantity") %>'></asp:TextBox>
                                <asp:LinkButton ID="btn_plus" runat="server" CommandArgument='<%# Eval("Quantity") %>' CommandName="Add" Text="+"><i class="fas fa-plus"></i></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
